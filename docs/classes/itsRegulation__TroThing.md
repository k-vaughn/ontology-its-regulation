...
![TroThing Diagram](../diagrams/itsRegulation__TroThing.dot.svg)
...
| [Rule Maker](itsRegulation__RuleMaker.md) | An entity that has the responsibility for creating and maintaining rules of the road or regulations for a geographic and operational scope as defined by the parent jurisdictional entity. |
...
| [Traffic Regulation Order](itsRegulation__TrafficRegulationOrder.md) |  |
